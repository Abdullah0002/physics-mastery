  ...
  return (
    <div className="space-y-4">
      ...
      <Button
        ...
        onClick={() => {
          if (!GOOGLE_ENABLED) {
            toast.error("Google sign-in is not configured yet. Use email & password below.");
            return;
          }
          setIsGoogleLoading(true);
          signIn("google", { callbackUrl: "/dashboard" });
        }}
        disabled={isGoogleLoading || !GOOGLE_ENABLED}
      >
        {isGoogleLoading ? (
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        <div className="space-y-1.5">
          ...
          <Input id="email" type="email" placeholder="arjun@example.com" {...register("email")} />
